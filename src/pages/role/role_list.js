...
export default function Role_list() {
  ...
  if (FormCheckAssign.muser === true) {
    frmCheck.push(
      <Grid item xs={2}>
        <Checkbox
          defaultChecked
          key={String('muser')}
          onClick={onAssignChange('muser').bind(this)}
          name="muser"
          inputProps={{ 'aria-label': 'controlled-checkbox' }}
        />
      </Grid>,
  ...
  if (FormCheckAssign.mhobby === true) {
    frmCheck.push(
      <Grid item xs={2}>
        <Checkbox
          defaultChecked
          key={String('mhobby')}
          onClick={onAssignChange('mhobby').bind(this)}
          name="mhobby"
          inputProps={{ 'aria-label': 'controlled-checkbox' }}
        />
      </Grid>,
